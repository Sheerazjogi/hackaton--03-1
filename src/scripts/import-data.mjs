...
const client = createClient({
  projectId: process.env.NEXT_PUBLIC_SANITY_PROJECT_ID="z2997vq8",
  dataset: process.env.NEXT_PUBLIC_SANITY_DATASET="production",
  token: process.env.SANITY_API_TOKEN="skpuMMHlaESrkolGp636zL5N9pfBzoZVriORVuj0HQwr0UYeM9pg2U2qjDWKVnwlZRQWSQMQuD58MQYlEzN5dMXHgz31ZwyVKg1v1IrBapHwLvFbPVDtqyFzZ5YM9ZIyBzPV0oOw2QGGzTQg7dtltUSSwomqIQk71VvaotAKHm75LNJ2bzzW",
